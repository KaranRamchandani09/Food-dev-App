    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('OW', 'Outwear'), ('S', 'Shirt'), ('SW', 'Sport Wear')], max_length=2)),
                ('label', models.CharField(choices=[('OW', 'Outwear'), ('S', 'Shirt'), ('SW', 'Sport Wear')], max_length=2)),
